...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    uploadTask.on(
      ...
      (error) => {
        setimageFileUploadingError('Couldn not upload Image(File must be less than 2MB)');
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4">
        ...
        />
        <div
          className="relative w-31 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full"
